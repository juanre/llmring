...
from llmring.mcp.server.protocol.json_rpc import JSONRPCRequest, JSONRPCResponse, JSONRPCError
...
class JSONRPCRouter:
    ...
    async def handle_request(
        ...
        if not is_initialized and request.method not in ["initialize", "ping", "shutdown"]:
