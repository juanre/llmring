...
"""
    ...
    messages = [
        ...
        Message(role="user", content="How do I handle database migrations in Django?"),
    ]
    ...
    print(
        f"Time saved: {first_time - second_time:.2f}s ({(1 - second_time/first_time)*100:.1f}% faster)"
    )
...
async def test_conversation_caching():
    ...
    messages = [
        ...
        Message(role="user", content="How should I implement search functionality?"),
    ]
